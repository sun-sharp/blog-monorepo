<template>
  <n-card :bordered="false" class="article-add">
    <div class="article-add-head">
      <span>md编辑器</span>
    </div>

    <v-md-editor v-model="text" :left-toolbar="leftToolbar" height="500px" :disabled-menus="[]" @upload-image="handleUploadImage"></v-md-editor>
  </n-card>
</template>

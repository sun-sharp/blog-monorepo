...
const transform: AxiosTransform = {
  ...
  beforeRequestHook: (config, options) => {
    const { capitalApiUrl, blogApiUrl, mockApiUrl, joinPrefix, joinParamsToUrl, formatDate, joinTime = true } = options;
...
export const AxiosCapital = new VAxios({
  timeout: 10 * 1000,
  // 接口前缀
  prefixUrl: urlPrefix,
  ...
  requestOptions: {
    ...
    // 接口地址
    capitalApiUrl: globSetting.capitalApiUrl as string,
  },

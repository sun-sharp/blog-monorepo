...
export const remove = (id: string) => {
  return RequestBlog.request({ url: `${basic}/${id}`, method: 'DELETE', responseOptions: { isShowSuccessMessage: true } });
};
...
export const daily = (params: ApiStartEndTimeParams): Promise<any[]> => {
  return RequestBlog.request({ url: `${basic}/daily`, method: 'GET', params });
};

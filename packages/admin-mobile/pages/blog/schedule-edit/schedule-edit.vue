        ...
        <u-form ref="formRef" :model="form" :rules="rules" label-position="top">
          ...
          <view class="schedule-edit-card card" :class="{ dark: isDark }">
            <u-form-item label="开始日期" prop="startDate" required>
              <view class="schedule-edit-select" :class="{ dark: isDark }" @click="showStartCalendar = true">
            ...
            <u-form-item label="结束日期" prop="endDate" required>
              <view class="schedule-edit-select" :class="{ dark: isDark }" @click="showEndCalendar = true">
            ...
            <u-form-item label="开始时间" prop="startTime">
              <view class="schedule-edit-select" :class="{ dark: isDark }" @click="showStartTime = true">
            ...
            <u-form-item label="结束时间" prop="endTime">
              <view class="schedule-edit-select" :class="{ dark: isDark }" @click="showEndTime = true">

<script lang="ts" setup>
  ...
  import { setupMove, useDragDot } from './hooks/useDragDot';
  import { DragProps } from './hooks/useDragResize';
  import { IDragData, resizeEmitType } from '/#/components/drag';
...
./hooks/useDragDot./hooks/useDragResize

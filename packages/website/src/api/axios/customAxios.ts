import { ResultEnum, VITE_API_URL_PREFIX, VITE_AUTHORIZATION_HEAD, ACCESS_TOKEN } from '@/constants';
 ...
 * @param {string} msg
 */
export const messageFun = (type: 'success' | 'error' | 'warning' | 'info' | 'loading', msg: string) => {
